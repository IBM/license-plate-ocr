...
In this Code Pattern, we will demonstrate how to leverage OCR and the "PowerAI Vision" object recognition service to identify and read license plates.
...
1. Photo of car is uploaded to PowerAI Vision dashboard.
...
2. [Upload training images to PowerAI Vision ](#2-upload-training-images-to-powerai-vision)
3. [Train and deploy model in PowerAI Vision](#3-Train-and-deploy-model-in-PowerAI-Vision)
...
## 3. Train and deploy model in PowerAI Vision
...
Then, click "Custom Assets" in the PowerAI Vision dashboard's upper menu.
